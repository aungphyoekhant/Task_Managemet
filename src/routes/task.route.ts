...
router.put(
  "/workspaces/:workspaceId/projects/:projectId/tasks/assigned/:taskId",
  auth,
  checkWorkspaceRole(["OWNER", "ADMIN", "MEMBER"]),
  taskController.updateAssignedTask
);

router.delete("/tasks/:taskId", auth, checkWorkspaceRole(["OWNER", "ADMIN"]), taskController.deleteTask);
