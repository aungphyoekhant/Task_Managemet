...
export const invitationController = {
    acceptInvitation: async (req, res) => {
        ...
        try {
            ...
            if (!secret)
                throw new Error("INVITATION_SECRET is not defined");
            ...
            await invitationService.processAcceptInvitation({ userId: existingUser.id, workspaceId: invitation.workspaceId, role: invitation.role }, { id: invitation.id, status: "ACCEPTED" });
