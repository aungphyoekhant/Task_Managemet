...
router.put("/workspaces/:workspaceId/projects/:projectId/tasks/assigned/:taskId", auth, checkWorkspaceRole(["OWNER", "ADMIN", "MEMBER"]), taskController.updateAssignedTask);
